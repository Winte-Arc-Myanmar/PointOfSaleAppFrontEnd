...
type PurchaseOrderTableColumnOptions = {
...
export function getPurchaseOrderTableColumns(
  options: PurchaseOrderTableColumnOptions = {},
  ...
  return [
    {
      ...
      render: (o) =>
        onView ? (
          ...
          <span className="text-sm font-medium text-foreground">{o.poNumber}</span>
        ),
    },
    {
      key: "status",
    ...
    },
    {
      ...
      render: (o) => <span className="text-sm text-foreground">{o.currency}</span>,
    },
    {
      key: "totalAmount",
      header: "Total",
      ...
      render: (o) => (
        <span className="font-mono text-sm font-medium text-foreground">{o.totalAmount}</span>
      ),
    },
    {
      ...
      className: "min-w-[140px]",
      render: (o) => (
        <span className="text-sm text-foreground">{formatDate(o.expectedDeliveryDate)}</span>
      ),
    },
    {
      key: "vendorId",
      ...
      render: (o) => (
        <span className="font-mono text-xs text-muted truncate" title={o.vendorId}>
          {o.vendorId}
        </span>
      ),
    },
