...
export function WinterArcLogo3D({ size = 48, className }: WinterArcLogo3DProps) {
  ...
  if (reduceMotion) {
    return (
      ...
      >
        <div
          className="winter-arc-logo-image flex h-[88%] w-[88%] items-center justify-center"
        >
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="pointer-events-none absolute bottom-0 left-1/2 h-[18%] w-[72%] -translate-x-1/2 rounded-[50%] bg-sky-950/25 blur-[6px] dark:bg-sky-300/15"
        animate={SHADOW}
        transition={{
          duration: 9,
          repeat: Infinity,
      ...
      >
        ...
        <div
          className="absolute inset-[6%] opacity-[0.12] dark:opacity-[0.18]"
          style={{
        ...
        <motion.div
          className="absolute inset-[4%] rounded-full border border-sky-800/25 dark:border-sky-200/20"
