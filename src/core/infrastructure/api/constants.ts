...
export const API_ENDPOINTS = {
  ...
  CHART_OF_ACCOUNTS: {
    ...
    BY_ID: (id: string) => `/v1/chart-of-accounts/${id}`,
  ...
  EXCHANGE_RATES: {
    LIST: "/v1/exchange-rates",
    BY_ID: (id: string) => `/v1/exchange-rates/${id}`,
    CREATE: "/v1/exchange-rates",
    UPDATE: (id: string) => `/v1/exchange-rates/${id}`,
    DELETE: (id: string) => `/v1/exchange-rates/${id}`,
  },
  TAX_RATES: {
    LIST: "/v1/tax-rates",
    BY_ID: (id: string) => `/v1/tax-rates/${id}`,
    CREATE: "/v1/tax-rates",
  ...
  MEMBERSHIPS: {
    ...
    REGISTER: "/v1/guest-wallets",
    TOPUP: (id: string) => `/v1/guest-wallets/${id}/top-up`,
    REFUND: (id: string) => `/v1/guest-wallets/${id}/refund`,
    CARDS: (id: string) => `/v1/guest-wallets/${id}/cards`,
    LEDGER: (id: string) => `/v1/guest-wallets/${id}/ledger`,
    AUDIT: (id: string) => `/v1/guest-wallets/${id}/audit`,
    SETTLEMENT_QUOTE: (id: string) => `/v1/guest-wallets/${id}/settlement-quote`,
    BEGIN_SETTLEMENT: (id: string) => `/v1/guest-wallets/${id}/begin-settlement`,
    CANCEL_SETTLEMENT: (id: string) => `/v1/guest-wallets/${id}/cancel-settlement`,
    CLOSE: (id: string) => `/v1/guest-wallets/${id}/settle`,
    VOID: (id: string) => `/v1/guest-wallets/${id}/void`,
  },
  GUEST_CARDS: {
    LIST: "/v1/guest-cards",
    BY_ID: (id: string) => `/v1/guest-cards/${id}`,
    CREATE: "/v1/guest-cards",
    DELETE: (id: string) => `/v1/guest-cards/${id}`,
    LOOKUP: "/v1/guest-cards/lookup",
    REPORT_LOST: (id: string) => `/v1/guest-cards/${id}/report-lost`,
    REPLACE: (id: string) => `/v1/guest-cards/${id}/replace`,
  },
  JOURNAL_ENTRIES: {
    LIST: "/v1/journal-entries",
    BY_ID: (id: string) => `/v1/journal-entries/${id}`,
    CREATE: "/v1/journal-entries",
    UPDATE: (id: string) => `/v1/journal-entries/${id}`,
    DELETE: (id: string) => `/v1/journal-entries/${id}`,
    LINES: (journalEntryId: string) => ({
      LIST: `/v1/journal-entries/${journalEntryId}/lines`,
      BY_ID: (id: string) => `/v1/journal-entries/${journalEntryId}/lines/${id}`,
      CREATE: `/v1/journal-entries/${journalEntryId}/lines`,
      UPDATE: (id: string) => `/v1/journal-entries/${journalEntryId}/lines/${id}`,
