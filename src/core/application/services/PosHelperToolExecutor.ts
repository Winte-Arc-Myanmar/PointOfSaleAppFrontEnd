...
const POS_MODULES: PosModuleHelp[] = [
  ...
  },
  {
    ...
    title: "Card tiers",
    href: "/card-tiers",
    summary: "Manage membership payment card tiers from the live card-tiers API.",
    steps: [
      "Open Card Tiers from CRM & Loyalty.",
      "Create a tier with rank, preload amount, funding, discount, and validity.",
      "Edits only apply to newly issued cards; retiring a tier leaves existing cards working.",
    ],
    aliases: ["membership", "member card", "card template", "loyalty card", "card tier"],
  },
  {
    id: "dashboard",
    title: "Dashboard",
    href: "/dashboard",
    summary: "See sales, item mix, till movements, guest cards, and loyalty as charts.",
    steps: [
      "Open Dashboard and choose a business-date range. Leave outlet on all outlets to include every outlet you can see.",
      "Switch tabs to chart sales, items, income and expenses, guest cards, or loyalty.",
      "Open Reports when you need the full tables or a printed Z-report.",
    ],
    aliases: ["dashboard", "sales summary", "item sales", "guest cards report", "loyalty report"],
  },
  {
    id: "reports",
    title: "Reports",
    href: "/reports",
    summary: "Read the full sales, item, till, guest-card, and loyalty figures, then print a Z-report.",
    steps: [
      "Open Reports and pick a business-date range. Leave outlet on all outlets to include every outlet you can see.",
      "Each tab lists the plain figures: sales summary, items, income and expenses, guest cards, loyalty, and the daily rollups.",
      "Print a Z-report or daily sales from the same screen when closing.",
    ],
